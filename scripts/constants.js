...
const BOT_MESSAGE_COMMUNITY_REVIEW = `📢✨ Before we assign a reviewer, we'll invite community pre-review. **See the [community review guidance](../docs/community-review.md) for both authors and reviewers.**`;
